...
urlpatterns = [
    ...
    path('admin-account-register',views.admin_account_register,name='admin_account_register'),
    ...
    path('admin-user-card',views.admin_user_card,name='admin_user_card'),
    ...
    path('admin-blank',views.admin_blank,name='admin_blank'),
    ...
    path('admin-error-404',views.admin_error_404,name='admin_error_404'),
    path('admin-form-product',views.admin_form_product,name='admin_form_product'),
